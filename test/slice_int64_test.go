...
func TestSliceInt64(t *testing.T) {
    ...
    a.VInt64 = append(a.VInt64, 3) 
    b = SliceTestObject{}
    b.VInt64 = append(b.VInt64, 5) // sa = {VB, VA, VA, VA, VA}, sb = {VB}
    ...
    b.VInt64 = append(b.VInt64, 5) 
    b.VInt64 = append(b.VInt64, 5) 
    b.VInt64 = append(b.VInt64, 5) // sa = {VB, VA, VA, VA, VA}, sb = {VA, VB, VB, VB, VB}
    testSliceInt64DiffAndApply(t, a, b, 5)
    
    // multiple insertion diff
    a.VInt64[0] = 3
    a.VInt64 = a.VInt64[:1] // sa = {VA}, sb = {VA, VB, VB, VB, VB}
    testSliceInt64DiffAndApply(t, a, b, 4)

    // multiple modifications and insertions diff
    a.VInt64[0] = 5
    a.VInt64 = append(a.VInt64, 3) // sa = {VA, VB}, sb = {VA, VB, VB, VB, VB}
    testSliceInt64DiffAndApply(t, a, b, 5)
}
